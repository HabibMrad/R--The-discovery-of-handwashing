...
### Project Flow:
<br/> [1. Meet Dr. Ignaz Semmelweis](#meet-dr-ignaz-semmelweis)
<br/> [2. The alarming number of deaths](#the-alarming-number-of-deaths)
<br/> [3. Death at the clinics](#death-at-the-clinics)
<br/> [4. The handwashing begins](#the-handwashing-begins)
<br/> [5. The effect of handwashing](#the-effect-of-handwashing)
<br/> [6. The effect of handwashing highlighted](#the-effect-of-handwashing-highlighted)
<br/> [7. More handwashing, fewer deaths?](#more-handwashing-fewer-deaths)
<br/> [8. A statistical analysis of Semmelweis handwashing data](#a-statistical-analysis-of-semmelweis-handwashing-data)
<br/> [9. The fate of Dr. Semmelweis](#the-fate-of-dr-semmelweis)
#### Note: The anchor tags will only work when the Rmd file is downloaded.
